...
const Dashboard = () => {
 ...
 /* useEffect(() => {
  ...
  useEffect(() => {
  // Temporary test session data
  const dummySession = {
    _id: "dummy123",
    role: "Frontend Developer",
    topicsToFocus: "React, JavaScript, CSS",
    experience: "1",
    description: "This session is for frontend interview practice.",
    updatedAt: new Date().toISOString(),
  };

  setSessions([dummySession]); // <-- Only for preview purposes
  // fetchAllSessions();  <-- Comment this while testing
}, []);
